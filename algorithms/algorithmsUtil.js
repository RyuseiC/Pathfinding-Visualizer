...
function getUnvisitedNeighborNodeObjects(nodeObject, nodeObjects, totalRows, totalCols) {
  ...
  let topNeighborNodeObject = nodeObject.row === 0 ? null : nodeObjects[[nodeObject.row - 1, nodeObject.col]];
  let bottomNeighborNodeObject = nodeObject.row + 1 === totalRows ? null : nodeObjects[[nodeObject.row + 1, nodeObject.col]];
  let leftNeighborNodeObject = nodeObject.col === 0 ? null : nodeObjects[[nodeObject.row, nodeObject.col - 1]];
